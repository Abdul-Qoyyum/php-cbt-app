            ...
            <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="<?=$this->domain()?>/student/dashboard">Home</a></li>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="<?=$this->domain()?>/<?=$student->profile_pix?>" class="img-circle" width="150" height="150">
                                    <h4 class="card-title m-t-10"><?=$student->name?></h4>
                                    <form action="<?=$this->domain()?>/student-manager/update-student-profile-pix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<?=$this->domain()?>/student-manager/update-profile" method="post" class="needs-validation" novalidate>
                                    <div class="form-group mb-3">
                                        <label for="validationCustom01">Lastname</label>
                                        <input type="text" class="form-control" value="<?=$student->lastname?>" name="lastname" id="validationCustom01" placeholder="Last Name" required>
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="validationCustom01">Middlename</label>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="email" class="form-control" value="<?=$student->email?>" name="email" id="validationCustom01" placeholder="Email" required>
                                        <div class="invalid-feedback">
                                ...
                                <hr>
                                <form action="<?=$this->domain()?>/student-manager/change-password" method="post" class="needs-validation" novalidate>
