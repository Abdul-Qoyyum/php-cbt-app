                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<?=$this->domain()?>/admin-manager/update-level/<?=$data['id']?>" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                                    <div class="form-group mb-3">
                                        <label for="validationCustom01">Level</label>
                                        <input type="text" class="form-control" value="<?=$level->level?>" name="level" id="validationCustom01" placeholder="Level" required>
                    ...
                    <div class="col-8">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="header-title">Levels</h4>
