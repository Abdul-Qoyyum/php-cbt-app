            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mb-3">Edit Subject</h4>
                                <form action="<?=$this->domain()?>/admin-manager/update-subject/<?=$data['id']?>" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                                    <div class="form-group mb-3">
                                        <label for="validationCustom01">Subject</label>
                                        <input type="text" class="form-control" value="<?=$subject->subject?>" name="subject" id="validationCustom01" placeholder="Subject" required>
